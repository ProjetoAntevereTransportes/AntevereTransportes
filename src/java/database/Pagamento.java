...
public class Pagamento {
    ...
    public List<contratos.Pagamento2> GetPayments(java.util.Date date) {
        try {
            abrir();
            ...
            String sql = "select parcela_pagamento.id,\n"
                    ...
                    + "                           DAY(parcela_pagamento.vencimento) = ?\n"
                    + "                            union\n"
            ...
            ps.setString(3, String.valueOf(c.get(Calendar.DATE)));
            ps.setString(4, String.valueOf(c.get(Calendar.YEAR) + 1900));
            ps.setString(5, new SimpleDateFormat("MM").format(c.getTime()));

            ps.setString(6, String.valueOf(date.getYear() + 1900));
            ps.setString(7, new SimpleDateFormat("MM").format(date));

            ps.setString(8, String.valueOf(date.getYear() + 1900));
            ps.setString(9, new SimpleDateFormat("MM").format(date));
            ps.setString(10, String.valueOf(c.get(Calendar.DATE)));
