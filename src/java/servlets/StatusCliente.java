 ...
 */
public class StatusCliente extends HttpServlet {
    ...
    public String lervarios() {
        JsonResult<List<contratos.StatusCliente>> json = new JsonResult<List<contratos.StatusCliente>>();

        database.StatusCliente data = new database.StatusCliente();
        List<contratos.StatusCliente> lstatus = data.listar();
